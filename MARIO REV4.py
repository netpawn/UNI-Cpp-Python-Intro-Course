...
def update():
    ...
    pt = 0
    pts = str(pt)
    draw_text(canvas, "Level 1 |" + " Punteggio = " + pts, (255, 255, 255), (5, 5), 10)
...
mario = Mario(arena, 800, 10, 210, 0)
luigi = Luigi(arena, 50, 10, 210, 188)
goomba = Goomba(arena, 800, 215, 0, 380)
mushroom = Mushroom(arena, 542, 85, 184, 671)

#---------------------------------------------

objects = []
cube = Cube(arena, 550, 100, 16, 16, 4, 641)
objects.append(cube)
